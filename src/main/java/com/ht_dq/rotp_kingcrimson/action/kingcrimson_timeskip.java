...
public class kingcrimson_timeskip extends StandEntityAction {
    ...
    //Todo:
    // Make it so that the ability can be used without KC
    // Balls
    // Make it so that player step height is increased during timeskip [giving up on this]
    ...
    public static class KingCrimsonAbility extends StandEntityAction {
        ...
        public void standPerform(World world, StandEntity standEntity, IStandPower userPower, StandEntityTask task) {
            if (!world.isClientSide()) {
                ...
                //VFX Stuff for everyone including King Crimson user.
                ...
                for (ServerPlayerEntity nearbyPlayer : nearbyPlayers) {
                    InitVFX.startVFXClient(nearbyPlayer.getUUID());
                }
