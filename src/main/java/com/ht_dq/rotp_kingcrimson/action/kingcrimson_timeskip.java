...
public class kingcrimson_timeskip extends StandEntityAction {
    ...
    public static class KingCrimsonAbility extends StandEntityAction {
        ...
        //TODO:
        // Make it so that Time Skip can be used without summoning the Stand
        // Look into a way to make the player have increased stepheight during time skip, if possible
        // Change Time skip from a hold-type ability to a normal one click ability.
