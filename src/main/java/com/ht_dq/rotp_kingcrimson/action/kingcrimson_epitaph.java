...
public class kingcrimson_epitaph extends StandEntityAction {
    ...
    //TODO:
    // Make it so that Epitaph can be used without summoning the Stand
    ...
    public static class EpitaphHandler {
        ...
        private void teleportAndCounter(PlayerEntity player, LivingEntity target) {
            ...
            IHasStandPunch counterAction = resolveLevel >= 4 ? InitStands.KINGCRIMSON_IMPALE.get() : InitStands.KINGCRIMSON_HEAVY_PUNCH.get();
