...
@OnlyIn(Dist.CLIENT)
public class TimeEraseSkyRenderer<T extends EndPortalTileEntity> extends TileEntityRenderer<T> {
    public static final ResourceLocation ERASE_SKY_LOCATION = new ResourceLocation(RotpKingCrimsonAddon.MOD_ID,"textures/environment/erase_sky.png");
    public static final ResourceLocation ERASE_PORTAL_LOCATION = new ResourceLocation(RotpKingCrimsonAddon.MOD_ID,"textures/entity/erase_sky_second.png");
    ...
    public TimeEraseSkyRenderer(TileEntityRendererDispatcher p_i226019_1_) {
        super(p_i226019_1_);
    }
