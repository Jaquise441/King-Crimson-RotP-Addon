...
public class KingCrimsonModel extends HumanoidStandModel<KingCrimsonEntity> {
	...
	protected void initActionPoses() {
		...
		ModelPose<KingCrimsonEntity> groundpunch0 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 17.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -45.235, 16.3882, 15.6337),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, -50),
				RotationAngle.fromDegrees(leftArm, -45.235, -16.3882, -15.6337),
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 50),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
		...
		ModelPose<KingCrimsonEntity> groundslam0 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 0, 0, 0),
				...
				RotationAngle.fromDegrees(rightLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 22.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 22.5, 0, 0)
		});
		ModelPose<KingCrimsonEntity> groundslam1 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, -15.31, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -102.461483538, 9.990384523, 0.4406689001),
				RotationAngle.fromDegrees(rightForeArm, -35, 0, 0),
				RotationAngle.fromDegrees(leftArm, -102.4784553233, -7.4928206685, -0.3290232005),
				RotationAngle.fromDegrees(leftForeArm, -31.11, 0, 0),
				RotationAngle.fromDegrees(torso, 0, 0, 0),
				RotationAngle.fromDegrees(rightLeg, 19.44, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 19.44, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 22.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 22.5, 0, 0)
		});
		ModelPose<KingCrimsonEntity> groundslam2 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, -17.5, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -102.46, 9.99, 0.44),
				RotationAngle.fromDegrees(rightForeArm, -45, 0, 0),
				RotationAngle.fromDegrees(leftArm, -102.48, -7.49, -0.33),
				RotationAngle.fromDegrees(leftForeArm, -40, 0, 0),
				RotationAngle.fromDegrees(torso, 0, 0, 0),
				RotationAngle.fromDegrees(rightLeg, 25, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 25, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 22.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 22.5, 0, 0)
		});
		ModelPose<KingCrimsonEntity> groundslam3 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				...
				RotationAngle.fromDegrees(leftForeArm, -40, 0, 0),
				RotationAngle.fromDegrees(torso, 0, 0, 0),
				RotationAngle.fromDegrees(rightLeg, 5.83, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 15.83, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 22.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 22.5, 0, 0)
		});
		ModelPose<KingCrimsonEntity> groundslam4 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 27.5, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -27.46, 9.99, 0.44),
				RotationAngle.fromDegrees(rightForeArm, -45, 0, 0),
				RotationAngle.fromDegrees(leftArm, -32.48, -7.49, -0.33),
				RotationAngle.fromDegrees(leftForeArm, -40, 0, 0),
				RotationAngle.fromDegrees(torso, 0, 0, 0),
				RotationAngle.fromDegrees(rightLeg, -32.5, 0, 0),
				RotationAngle.fromDegrees(leftLeg, -2.5, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 22.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 22.5, 0, 0)
		});

		actionAnim.put(KingCrimsonGroundSlam.SLAM, new PosedActionAnimation.Builder<KingCrimsonEntity>()
				.addPose(StandEntityAction.Phase.WINDUP, new ModelPoseTransitionMultiple.Builder<>(idlePose)
						.addPose(0.0F, groundslam0)
						.addPose(0.29F, groundslam1)
						.addPose(0.38F, groundslam2)
						.addPose(0.42F, groundslam3)
						.build(groundslam4))
				.addPose(StandEntityAction.Phase.RECOVERY, new ModelPoseTransitionMultiple.Builder<>(groundslam4)
						.addPose(0.5F, groundslam4)
						.build(idlePose))
				.build(idlePose));

		ModelPose<KingCrimsonEntity> throw0 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 0, 0, 0),
				...
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 0),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, -10, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 35, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 27.5, 0, 0)
		});

		ModelPose<KingCrimsonEntity> throw1 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 0, 0, 0),
		...
		ModelPose<KingCrimsonEntity> throw2 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 6.92, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 12.56, 4.32, 21.83),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, -45),
				RotationAngle.fromDegrees(leftArm, 0.97, -5.69, -2.35),
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 1.92),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, -10, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 35, 0, 0),
		...
		ModelPose<KingCrimsonEntity> throw3 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 45, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 81.66, 28.05, 141.88),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, -45),
				RotationAngle.fromDegrees(leftArm, 6.2853414971, -37.014385369, -15.2796223725),
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 12.5),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, -10, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 35, 0, 0),
		...
		ModelPose<KingCrimsonEntity> throw4 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, 12, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 87.9432705991, 30.2105047235, 152.7948216902),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, -0.25),
				RotationAngle.fromDegrees(leftArm, 3.77, -11.21, -9.17),
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 7.5),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, -10, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 35, 0, 0),
		...
		ModelPose<KingCrimsonEntity> throw5 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 0, 0, 0),
				RotationAngle.fromDegrees(body, 0, -37.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -51.7570507012, 12.1485714936, 72.4936763001),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, -2.5),
				RotationAngle.fromDegrees(leftArm, 0, 27.5, 0),
				RotationAngle.fromDegrees(leftForeArm, 0, 0, 0),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, -10, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
		...
		actionAnim.put(KingCrimsonProjectileThrow.THROW, new PosedActionAnimation.Builder<KingCrimsonEntity>()
				.addPose(StandEntityAction.Phase.WINDUP, new ModelPoseTransitionMultiple.Builder<>(idlePose)
						.addPose(0.0F, throw0)
		...
		ModelPose<KingCrimsonEntity> eyejab0 = new ModelPose<>(new RotationAngle[]{
				...
				RotationAngle.fromDegrees(body, 0, 0, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -90.0534444682, 0.3472300905, 90.0243988447),
				RotationAngle.fromDegrees(rightForeArm, 0, 0, 0),
				RotationAngle.fromDegrees(leftArm, -49.5675389138, -7.6442700563, -6.4663543942),
				RotationAngle.fromDegrees(leftForeArm, -46.3570707435, -65.446827567, 43.6429341687),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 2.5, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 10, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 12.5, 0, 0),
				RotationAngle.fromDegrees(rightLowerLeg, 17.5, 0, 0)
		});
		ModelPose<KingCrimsonEntity> eyejab1 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -9.37, 0, 0),
				RotationAngle.fromDegrees(body, 0, 24.38, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -18.8, 0.35, 90.02),
				RotationAngle.fromDegrees(rightForeArm, -91.87, 0, 0),
				RotationAngle.fromDegrees(leftArm, -47.2051253924, -18.8895204322, -16.6854073504),
				RotationAngle.fromDegrees(leftForeArm, -46.36, -65.45, 43.64),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 2.5, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 10, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 12.5, 0, 0),
		...
		ModelPose<KingCrimsonEntity> eyejab2 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -12.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 32.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, 4.9465555318, 0.3472300905, 90.0243988447),
				RotationAngle.fromDegrees(rightForeArm, -122.5, 0, 0),
				RotationAngle.fromDegrees(leftArm, -47.21, -18.89, -16.69),
				RotationAngle.fromDegrees(leftForeArm, -46.36, -65.45, 43.64),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 2.5, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 10, 0, 0),
		...
		ModelPose<KingCrimsonEntity> eyejab3 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -12.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 32.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -8.18, 0.35, 90.02),
				RotationAngle.fromDegrees(rightForeArm, -91.88, 22.5, 0),
				RotationAngle.fromDegrees(leftArm, -47.21, -18.89, -16.69),
				RotationAngle.fromDegrees(leftForeArm, -46.36, -65.45, 43.64),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 2.5, 0, 0),
		...
		ModelPose<KingCrimsonEntity> eyejab4 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -12.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 32.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -21.3, 0.35, 90.02),
				RotationAngle.fromDegrees(rightForeArm, -61.25, 45, 0),
				RotationAngle.fromDegrees(leftArm, -47.21, -18.89, -16.69),
				RotationAngle.fromDegrees(leftForeArm, -54.95, -50.55, 55.12),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 0, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 0, 0, 0),
		...
		ModelPose<KingCrimsonEntity> eyejab5 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -12.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 32.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -21.3, 0.35, 90.02),
		...
		ModelPose<KingCrimsonEntity> eyejab6 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, -12.5, 0, 0),
				RotationAngle.fromDegrees(body, 0, 32.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -21.3, 0.35, 90.02),
		...
		ModelPose<KingCrimsonEntity> eyejab7 = new ModelPose<>(new RotationAngle[]{
				RotationAngle.fromDegrees(head, 10, 0, 0),
				RotationAngle.fromDegrees(body, 0, -42.5, 0),
				RotationAngle.fromDegrees(upperPart, 0, 0, 0),
				RotationAngle.fromDegrees(rightArm, -47.5534444682, 0.3472300905, 90.0243988447),
				RotationAngle.fromDegrees(rightForeArm, 0, 90, 0),
				RotationAngle.fromDegrees(leftArm, -22.21, -18.89, -16.69),
				RotationAngle.fromDegrees(leftForeArm, -72.1435232458, -20.753102407, 78.0664905076),
				RotationAngle.fromDegrees(torso, 0.0F, 0.0F, 0.0F),
				RotationAngle.fromDegrees(rightLeg, 2.5, 0, 0),
				RotationAngle.fromDegrees(leftLeg, 10, 0, 0),
				RotationAngle.fromDegrees(leftLowerLeg, 12.5, 0, 0),
		...
		actionAnim.put(KingCrimsonDesperateEyejab.JAB, new PosedActionAnimation.Builder<KingCrimsonEntity>()
				.addPose(StandEntityAction.Phase.WINDUP, new ModelPoseTransitionMultiple.Builder<>(idlePose)
						.addPose(0.0F, eyejab0)
						.addPose(0.38F, eyejab1)
						.addPose(0.50F, eyejab2)
						.addPose(0.54F, eyejab3)
						.addPose(0.58F, eyejab4)
						.addPose(0.62F, eyejab5)
						.addPose(0.66F, eyejab6)
						.build(eyejab7))
				.addPose(StandEntityAction.Phase.RECOVERY, new ModelPoseTransitionMultiple.Builder<>(eyejab7)
						.addPose(0.77F, eyejab7)
						.build(idlePose))
				.build(idlePose));
